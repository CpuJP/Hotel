 ...
 * @author jp-co
 */
public class MedicosDisponibles extends javax.swing.JDialog {

    /**
     * Creates new form MedicosDisponibles
     */
    public MedicosDisponibles(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Médicos disponibles");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MedicosDisponibles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MedicosDisponibles dialog = new MedicosDisponibles(new javax.swing.JFrame(), true);
